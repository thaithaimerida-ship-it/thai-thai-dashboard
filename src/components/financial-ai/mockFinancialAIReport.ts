...
export const mockFinancialAIReport: FinancialReport = {
  ...
  resumen_financiero: {
    ingresos_brutos_financieros: 520000,
    comisiones_totales: 33760,
    ingresos_netos_financieros: 486240,
    meta_ventas_netas: 325000,
    punto_equilibrio: 295000,
    diferencia_vs_meta: 161240,
    diferencia_vs_punto_equilibrio: 191240,
    cumplimiento_meta_pct: 149.61,
    cumplimiento_pe_pct: 164.83,
  },
  rentabilidad: {
    food_cost_monto: 149765,
    food_cost_pct: 30.8,
    labor_monto: 108918,
    labor_pct: 22.4,
    costo_primo_monto: 258683,
    costo_primo_pct: 53.2,
    cash_yield_pct: 15.4,
    utilidad_neta: 74881,
    datos_no_disponibles: [],
  },
  caja_operativa: {
    venta_con_impuesto: 564038,
    impuesto_total: 77800,
    venta_neta_caja: 486238,
    comensales: 1621,
